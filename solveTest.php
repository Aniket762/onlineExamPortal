...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Springer Public School</title>
  ...
  <body onLoad="timeout()">
    <div class="container">
      ...
      <ul class="nav nav-tabs">
        <li class="active" style="height:50px; font-size:20px;"><a data-toggle="tab" data-target="#mcq">Multiple Choice Questions</a></li>
        <li style="height:50px; font-size:20px;"><a data-toggle="tab" data-target="#desc">Descriptive Type Questions</a></li>
      </ul>
      <form id="quiz" method="post" action="showResult.php">
        <div class="tab-content">
          <div id="mcq" class="tab-pane in fade active" style="height:50px; font-size:20px;">
                  ...
                  <tr>
                    <?php
                      if(strlen($q_res['image'])>10){ ?>
                        <img src="<?php echo $q_res['image'] ?>" style="max-height:300px;max-width:400px; text-align:center"></img><br>
                    <?php  }?>
                  </tr>
          	      <tr>
          	        <td style="background-color:#e8ffff; height:50px; font-size:20px;"><input type="radio" value="a" name="<?php echo $q_res['question_id'] ?>">
          	        <?php echo $q_res['option_a'] ?></td>
          	      </tr>
          	      <tr>
          	        <td style="background-color:#d9f1ff; height:50px; font-size:20px;"><input type="radio" value="b" name="<?php echo $q_res['question_id'] ?>">
          	        <?php echo $q_res['option_b'] ?></td>
          	      </tr>
          	      <tr>
          	        <td style="background-color:#bfe6ff; height:50px; font-size:20px;"><input type="radio" value="c" name="<?php echo $q_res['question_id'] ?>">
          	        <?php echo $q_res['option_c'] ?></td>
          	      </tr>
          	      <tr>
          	        <td style="background-color:#8cd3ff; height:50px; font-size:20px;"><input type="radio" value="d" name="<?php echo $q_res['question_id'] ?>">
