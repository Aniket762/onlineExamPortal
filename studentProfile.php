...
<html lang="en">
		...
		<nav class="navbar navbar-inverse">
		  <div class="container-fluid">
		    <div class="navbar-header">
		      <a class="navbar-brand" href="studentHome.php">Springer Public School</a>
		    </div>
    ...
    <div class="container">
			<p style="font-size:30px; margin-left:300px; " >Name: <?php echo $results_user['username'];?> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
			Email: <?php echo $results_user['email'];?></p><br>
			<table class="table" style="font-size:px">
        <thead>
